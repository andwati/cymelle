        ...
        <main className="min-h-screen bg-background">
            ...
            <section className="mx-auto max-w-7xl px-4 py-8">
                <div className="mb-6 max-w-2xl">
                    <p className="text-sm font-medium uppercase text-muted-foreground">Store</p>
                    <h1 className="mt-2 text-4xl font-bold tracking-normal text-foreground">Shop Cymelle products</h1>
                </div>
                <ProductGrid
